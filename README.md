...
optional `wav` one. The largest single share is this project's own 4 s output
buffer, not the speaker. An earlier figure of 13 s, most of it blamed on the
speaker's prebuffer, did not survive being measured again.
