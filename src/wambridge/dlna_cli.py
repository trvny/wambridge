...
def _advertised_host(speaker_ip: str) -> str:
    """Return the local address selected by the route to the speaker."""

    return local_ip_for(speaker_ip)
...
def run(args: argparse.Namespace) -> int:
    ...
    host_ip = _advertised_host(speaker_ip)
